...
| 4단계 | v0.5.2 ARM64 OCI image 게시와 v0.4.0 Raspberry Pi 5 고정 2센서 환경변수 주입 검증 완료 | 실제 수신 프로그램 통합, 다른 edge process와의 공유 부하 검증 및 허용 기준 |
...
식별자 및 대표 시각을 기록한다.
두 번째 목표의 `v0.5.2` Release와 digest 기반 실행 산출물이 게시됐다. Raspberry Pi 5의
