...
from scrap_monitoring_lidar_simulator.geometry import Polygon2, Ray, RayBatch, Vec2
from scrap_monitoring_lidar_simulator.geometry.intersections import DEFAULT_MIN_DISTANCE_M
from scrap_monitoring_lidar_simulator.scenario._height_field_batch_intersection import (
    intersect_height_field_batch,
)
from scrap_monitoring_lidar_simulator.scenario._height_field_intersection import (
