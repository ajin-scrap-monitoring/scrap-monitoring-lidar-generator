...
from scrap_monitoring_lidar_simulator.geometry.batch_intersections import contains_xy
from scrap_monitoring_lidar_simulator.geometry.batches import FloatArray, RayBatch
