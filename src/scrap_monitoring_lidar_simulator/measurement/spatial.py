...
from scrap_monitoring_lidar_simulator.geometry import EnvironmentScene, Polygon2, SensorFrame, Vec2
from scrap_monitoring_lidar_simulator.geometry.intersections import validate_distance_bounds
from scrap_monitoring_lidar_simulator.geometry.scene import HitKind
from scrap_monitoring_lidar_simulator.measurement._randomness import (
    derive_global_seed,
    require_seed,
)
from scrap_monitoring_lidar_simulator.measurement.models import TimedReferenceScan
